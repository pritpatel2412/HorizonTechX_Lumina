import { useGetTrendingTags, useGetUserSuggestions, useToggleFollow } from "@workspace/api-client-react";
...
export function RightSidebar() {
  ...
  return (
    <aside className="sticky top-0 h-screen hidden w-[300px] flex-col gap-6 py-6 pr-6 lg:flex">
      
      {/* Search could go here, but requirements put it on Explore */}
              ...
              <div key={user.id} className="flex items-center justify-between gap-2 group">
                ...
                <Button 
                  ...
                  className={cn(
                    ...
                    !user.isFollowing && "bg-white/10 hover:bg-white/20 text-white border-0"
                  )}
